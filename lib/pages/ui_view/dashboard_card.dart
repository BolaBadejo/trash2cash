...
class DashboardCard extends StatelessWidget {
  ...
  const DashboardCard({Key? key, this.animationController, this.animation})
      : super(key: key);
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      fontWeight: FontWeight.w600,
                                      fontSize: 12,
                                      color: Trash2CashTheme.nearlyBlue
                                          .withOpacity(0.5),
                                    ),
                                  ),
                                ),
