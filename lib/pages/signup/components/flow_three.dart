...
import 'package:trash2cash/model/file_model.dart';
import 'package:trash2cash/pages/home_screen.dart';
import 'package:trash2cash/pages/homepage/home_page.dart';
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      onChanged: (value) {
                        signUpController.setBirthYear(value);
                      },
                      onSubmitted: (value) {
                        signUpController.setBirthYear(value);
                      },
                    ...
                    ElevatedButton(
                      ...
                      child: const Text("Upload your utility bill"),
                    ),
                    const SizedBox(
                      height: 3,
                    ),
                    ...
                    MyButton(
                      onPressed: () {
                        if (
                                signUpController.imageFile != null &&
                                signUpController.birthYear != null) {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => T2CHomeScreen()));
                          signUserUp();
